 ...
 *                There must be 16 points; otherwise, an error will occur
 *                during evaluation.
 ...
 */
class BezierPatch(control: Animatable[Vector[Vector3]],
  ...
  private def evalNormal(u: Float, v: Float): Vector3 = {
    val c = control()
    if (c.length != 16)
      throw new IllegalStateException("Dim of control point array != 16")

    val du = c(idx(0, 0)) * (deriv_b_3_0(u) * b_3_0(v)) +
      c(idx(0, 1)) * (deriv_b_3_0(u) * b_3_1(v)) +
      c(idx(0, 2)) * (deriv_b_3_0(u) * b_3_2(v)) +
      c(idx(0, 3)) * (deriv_b_3_0(u) * b_3_3(v)) +
      c(idx(1, 0)) * (deriv_b_3_1(u) * b_3_0(v)) +
      c(idx(1, 1)) * (deriv_b_3_1(u) * b_3_1(v)) +
      c(idx(1, 2)) * (deriv_b_3_1(u) * b_3_2(v)) +
      c(idx(1, 3)) * (deriv_b_3_1(u) * b_3_3(v)) +
      c(idx(2, 0)) * (deriv_b_3_2(u) * b_3_0(v)) +
      c(idx(2, 1)) * (deriv_b_3_2(u) * b_3_1(v)) +
      c(idx(2, 2)) * (deriv_b_3_2(u) * b_3_2(v)) +
      c(idx(2, 3)) * (deriv_b_3_2(u) * b_3_3(v)) +
      c(idx(3, 0)) * (deriv_b_3_3(u) * b_3_0(v)) +
      c(idx(3, 1)) * (deriv_b_3_3(u) * b_3_1(v)) +
      c(idx(3, 2)) * (deriv_b_3_3(u) * b_3_2(v)) +
      c(idx(3, 3)) * (deriv_b_3_3(u) * b_3_3(v))

    val dv = c(idx(0, 0)) * (b_3_0(u) * deriv_b_3_0(v)) +
      c(idx(0, 1)) * (b_3_0(u) * deriv_b_3_1(v)) +
      c(idx(0, 2)) * (b_3_0(u) * deriv_b_3_2(v)) +
      c(idx(0, 3)) * (b_3_0(u) * deriv_b_3_3(v)) +
      c(idx(1, 0)) * (b_3_1(u) * deriv_b_3_0(v)) +
      c(idx(1, 1)) * (b_3_1(u) * deriv_b_3_1(v)) +
      c(idx(1, 2)) * (b_3_1(u) * deriv_b_3_2(v)) +
      c(idx(1, 3)) * (b_3_1(u) * deriv_b_3_3(v)) +
      c(idx(2, 0)) * (b_3_2(u) * deriv_b_3_0(v)) +
      c(idx(2, 1)) * (b_3_2(u) * deriv_b_3_1(v)) +
      c(idx(2, 2)) * (b_3_2(u) * deriv_b_3_2(v)) +
      c(idx(2, 3)) * (b_3_2(u) * deriv_b_3_3(v)) +
      c(idx(3, 0)) * (b_3_3(u) * deriv_b_3_0(v)) +
      c(idx(3, 1)) * (b_3_3(u) * deriv_b_3_1(v)) +
      c(idx(3, 2)) * (b_3_3(u) * deriv_b_3_2(v)) +
      c(idx(3, 3)) * (b_3_3(u) * deriv_b_3_3(v))
  ...
  private def evalVertex(u: Float, v: Float): Vector3 = {
    ...
    c(idx(0, 0)) * (b_3_0(u) * b_3_0(v)) +
      c(idx(0, 1)) * (b_3_0(u) * b_3_1(v)) +
      c(idx(0, 2)) * (b_3_0(u) * b_3_2(v)) +
      c(idx(0, 3)) * (b_3_0(u) * b_3_3(v)) +
      c(idx(1, 0)) * (b_3_1(u) * b_3_0(v)) +
      c(idx(1, 1)) * (b_3_1(u) * b_3_1(v)) +
      c(idx(1, 2)) * (b_3_1(u) * b_3_2(v)) +
      c(idx(1, 3)) * (b_3_1(u) * b_3_3(v)) +
      c(idx(2, 0)) * (b_3_2(u) * b_3_0(v)) +
      c(idx(2, 1)) * (b_3_2(u) * b_3_1(v)) +
      c(idx(2, 2)) * (b_3_2(u) * b_3_2(v)) +
      c(idx(2, 3)) * (b_3_2(u) * b_3_3(v)) +
      c(idx(3, 0)) * (b_3_3(u) * b_3_0(v)) +
      c(idx(3, 1)) * (b_3_3(u) * b_3_1(v)) +
      c(idx(3, 2)) * (b_3_3(u) * b_3_2(v)) +
      c(idx(3, 3)) * (b_3_3(u) * b_3_3(v))
  }
  ...
  override def boundingSphere: BoundingSphere =
    control().foldLeft(EmptyBoundingSphere: BoundingSphere)((accum, cur) => accum.expand(cur))
